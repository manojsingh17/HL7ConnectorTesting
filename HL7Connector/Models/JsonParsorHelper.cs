...
namespace HL7CreationFromJson
{
    class JsonParserHelper
    {
        ...
        public static JsonHL7Fields ParseJsonHL7Fields(string jsonData)
        {
            ...
            oRet.AppointmentId = Convert.ToString(jsonObj["fields"]["AppointmentId"]["value"]);
            ...
            oRet.PhysicianFirstName = Convert.ToString(jsonObj["fields"]["PhysicianFirstName"]["value"]);
            oRet.PhysicianLastName = Convert.ToString(jsonObj["fields"]["PhysicianLastName"]["value"]);
            oRet.PhysicianMiddleName = Convert.ToString(jsonObj["fields"]["PhysicianMiddleName"]["value"]);
            oRet.PhysicianSuffix = Convert.ToString(jsonObj["fields"]["PhysicianSuffix"]["value"]);
            oRet.PhysicianPrefix = Convert.ToString(jsonObj["fields"]["PhysicianPrefix"]["value"]);
            ...
            //// Add ICD Codes
            //string IcdCodes = Convert.ToString(jsonObj["fields"]["Comments"]["value"]);
